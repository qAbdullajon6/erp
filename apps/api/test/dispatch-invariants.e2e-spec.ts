...
async function createDispatch(
  ...
  overrides: {
    driverId?: string;
    vehicleId?: string;
    status?: "DRAFT" | "ASSIGNED" | "EN_ROUTE_TO_PICKUP" | "AT_PICKUP" | "IN_TRANSIT" | "AT_STOP" | "ARRIVED_AT_DELIVERY" | "DELIVERED" | "CANCELLED";
    pickup?: Date;
    delivery?: Date;
  } = {},
) {
...
describe("dispatch database invariants (ADR-001 Phase 1)", () => {
  ...
  describe("R1 — only ACTIVE statuses reserve", () => {
    ...
    it.each(["EN_ROUTE_TO_PICKUP", "AT_PICKUP", "IN_TRANSIT", "AT_STOP"] as const)(
