...
export const ACTION_DEFINITIONS: ActionDefinition[] = [
  ...
  { type: 'delete_entity', displayName: 'Delete Record', description: 'Delete a notification in this organization only' },
  ...
  { type: 'generate_report', displayName: 'Generate Report', description: 'Placeholder — does not produce a report yet' },
  ...
  { type: 'approval', displayName: 'Manual Approval', description: 'Pauses execution — resume API not yet available (execution stays WAITING)' },
