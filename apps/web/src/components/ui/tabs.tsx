...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // The strip shrink-wraps its triggers, which never wrap — so a set of four
      // longish labels ("Executive Overview", "Fleet Telematics") was wider than
      // a phone and scrolled the whole document sideways. Capping it at the
