...
export function creditUtilization(creditLimit: string | number | null | undefined, outstanding: number): number | null {
  if (creditLimit == null) return null; // no credit limit configured
