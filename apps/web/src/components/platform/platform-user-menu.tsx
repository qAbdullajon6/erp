...
/// Platform Console user menu — never links into tenant `/app/*` settings.
  ...
  return (
    <>
      <DropdownMenu>
        <DropdownMenuTrigger className="flex items-center gap-2 rounded-lg px-2 py-1.5 transition-colors hover:bg-brand/10 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">
          ...
          <span className="hidden text-left sm:block">
            ...
            <span className="block text-xs leading-tight text-muted-foreground">Platform staff</span>
          </span>
      ...
      <ConfirmDialog
        ...
        description="You'll need to sign in again to manage organizations and support."
